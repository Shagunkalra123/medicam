...
<div class="card-header" id="headername" style="font-weight:solid">
    Add/ Update Association With Medicam
</div>
<div class="card-body">
<div class="cc_wrapper">
                ...
                <center>
                    ...
                    {{csrf_field()}}
                    <label for="associationwithmedicam_name" class="col-2 col-form-label col-md-offset-2">Add Association With Medicam : </label>
						          <div class="col-3">
                            <input class="form-control noerror" type="text" placeholder="Association With Medicam Name" name="associationwithmedicam_name" id="associationwithmedicam_name">
                        </div>
              ...
              <table class=" table nowrap data-table table-responsive display cell-border" style="width:100%" cellspacing="0"  id="data_table">
                ...
                <tr class="table_head">
                  <th>Sr. No.</th>
                  <th>Association With Medicam</th>
                  <th>Date added</th>
                  <th>Is Active</th>
                  <th>Action</th>
                </thead>
...
$('#add_associationwithmedicam').click(function (e) {
        ...
        var formData = new FormData(myForm);
          ...
          success: function (data) {
              ...
              $('#associationwithmedicam_form').trigger("reset");
                  ...
                  Swal.fire({
                    title: 'Association With Medicam is created',
                    animation: false,
    ...
    $('button.editassociationwithmedicam').click(function()
        ...
        var formData = new FormData(myForm);
          ...
          success: function (data) {
              ...
              Swal.fire({
                  title: 'Association With Medicam is updated',
                  animation: false,
    ...
    $('.active').change(function (e) {
        ...
        if(active_id==1)
        {
          ...
          success: function (data) {
            Swal.fire({
                title: 'Association With Medicam deactivated successfully',
                animation: false,
        ...
        else if(active_id==0)
        {
          ...
          success: function (data) {
            Swal.fire({
                title: 'Association With Medicam activated successfully',
                animation: false,
